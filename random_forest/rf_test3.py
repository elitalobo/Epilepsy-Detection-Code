...
fpr_rf, tpr_rf, _ = roc_curve(outputs2, y_pred_rf)
...
train_sizes, train_scores, test_scores = learning_curve(
        rfc, new_inputs, new_outputs, n_jobs=-1,cv=10, train_sizes=np.linspace(.1, 1., 10), verbose=0)
...
plt.gca().invert_yaxis()
#plt.legend()
plt.savefig("images/Random_Forest_Classifier_result1.png")
plt.clf()	
