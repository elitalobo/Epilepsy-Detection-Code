...
settings = {
    ...
    "layers"                : [ (300, sigmoid_function), (200, tanh_function), (100, sigmoid_function) ],
                                        # [ (number_of_neurons, activation_function) ]
                                        # The last pair in you list describes the number of output signals
    
    # Optional settings
    "weights_low"           : 0.0001,     # Lower bound on initial weight range
    "weights_high"          : 0.001,      # Upper bound on initial weight range
